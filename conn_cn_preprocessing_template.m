NSUBJECTS = 184;
base_dir = '/Volumes/Sandisk/AD_fMRI_GNN/CN_bids';
...
for nsub = 1:NSUBJECTS
    ...
    found_func_files = conn_dir(fullfile(current_sub_dir, 'func','*_task-rest_bold.nii'));
    ...
    found_anat_files = conn_dir(fullfile(current_sub_dir, 'anat', '*_T1w.nii'));
...
clear batch;
batch.filename=fullfile(cwd,'conn_preprocessing_template.mat');           
...
conn
conn('load',fullfile(cwd,'conn_preprocessing_template.mat'));
conn gui_results
